...
GO2_CONFIG = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.3),
        joint_pos={
            "FL_hip_joint": 0.3, "FL_thigh_joint": 0.8, "FL_calf_joint": -1.6,
            "FR_hip_joint": -0.3, "FR_thigh_joint": 0.8, "FR_calf_joint": -1.6,
            "RL_hip_joint": 0.3, "RL_thigh_joint": 0.8, "RL_calf_joint": -1.6,
            "RR_hip_joint": -0.3, "RR_thigh_joint": 0.8, "RR_calf_joint": -1.6
        },
    ),
