...
class RewardsCfg:
    ...
    # This term helps encourage the robot to land on all four feet
    # However it may encourage front and back feet collision so we don't use it
    # desired_contacts = RewTerm(
    #     func=mdp.desired_contacts_sum,
    #     weight=0.5,
    #     params={
    ...
    # This term prevents the robot from jumping by penalizing no feet on the ground
    stay_on_ground = RewTerm(
